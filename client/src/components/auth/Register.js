...
export const Register = ({ setAlert, register, isAuthenticated}) => {
    ...
    return (
        <Fragment>
            ...
            <p className="lead"><i className="fas fa-user"></i> Create Your SelfCycle Account</p>
